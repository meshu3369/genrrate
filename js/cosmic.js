	...
	$('.popup-gallery').magnificPopup({
		...
		image: {
			...
			titleSrc: function(item) {
				return item.el.attr('title') + '<small>by Seema</small>';
			}
		}
	});
...
function vegasHeader(){
	...
	$(".slide-show2").vegas({
	    slides: [
	        { src: "img/background/slider1.jpg"},
	        { src: "img/background/slider2.jpg"},
	        { src: "img/background/slider3.jpg"}
...
function typed () {
  $('.type-writer .type-here').typed({
        strings: ["LIFE","FRIENDS", "FUN", "Fame", "BUSINESS","SUCCESS","NOW" ],
        typeSpeed: 70,
        backDelay: 2000,
        loop: true,
      });
